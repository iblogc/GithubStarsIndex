...
> `#AI智能体` `#Cordis框架` `#插件化架构` `#cordis` `#dsh` `#dsh-plugin` 
...
> `#AI设计工具` `#多端原型生成` `#编码代理集成` `#agent-skills` `#ai-agents` `#ai-design` `#byok` `#claude-code-for-design` `#claude-design` `#codex-design` `#coding-agents` `#cursor-design` `#deepseek-harness` `#design-systems` `#design-tools` `#desktop-app` `#figma-alternative` `#generative-ai` `#hermes-agent` `#local-first` `#prototyping` `#ui-generator` `#vibe-coding` 
